...
function App() {
    ...
    useEffect(() => {
        ...
        socket.on('audio_data', (data) => {
            ...
            const amp = data.data.reduce((a, b) => a + b, 0) / data.data.length / 255;
            aiAudioAmpRef.current = amp;
        });
    ...
    // Now handled via aiAudioAmpRef to prevent re-renders
