...
const ConfirmationPopup = ({ request, onConfirm, onDeny }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-lg p-8 bg-black/90 border border-amber-500/30 rounded-3xl shadow-[0_0_50px_rgba(251,191,36,0.15)] backdrop-blur-2xl transform transition-all scale-100">
                ...
                <div className="flex items-center gap-4 mb-6 relative z-10">
                    <div className="p-3 rounded-full bg-amber-900/30 border border-amber-500/50 text-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.2)]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                    </div>
                    <div>
                        <h2 className="text-xl font-bold text-amber-400 tracking-wider font-mono drop-shadow-sm">
                            AUTHORIZATION REQUIRED
                        </h2>
                        <p className="text-xs text-amber-600 font-mono tracking-widest uppercase">
                ...
                <div className="mb-8 space-y-4 relative z-10">
                    ...
                    <div className="space-y-2">
                        <div className="bg-amber-950/30 border border-amber-800/50 rounded-xl overflow-hidden">
                            <div className="bg-amber-900/40 px-4 py-2 border-b border-amber-800/50 flex justify-between items-center">
                                <span className="text-xs text-amber-400 font-bold uppercase tracking-wider">Function</span>
                        ...
                        <div className="bg-amber-950/30 border border-amber-800/50 rounded-xl overflow-hidden">
                            <div className="bg-amber-900/40 px-4 py-2 border-b border-amber-800/50 flex justify-between items-center">
                                <span className="text-xs text-amber-400 font-bold uppercase tracking-wider">Parameters</span>
                ...
                <div className="flex gap-4 relative z-10">
                    ...
                    <button
                        onClick={onConfirm}
                        className="flex-1 px-4 py-3.5 rounded-xl border border-amber-500/30 bg-amber-950/40 text-amber-400 hover:bg-amber-900/60 hover:border-amber-400 hover:text-amber-300 transition-all duration-200 font-bold tracking-wider uppercase text-xs shadow-[0_0_20px_rgba(251,191,36,0.1)] hover:shadow-[0_0_30px_rgba(251,191,36,0.25)] relative overflow-hidden group"
                    >
                        <span className="relative z-10">Authorize Execution</span>
                        <div className="absolute inset-0 bg-amber-400/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
                    </button>
                </div>
            </div>
        </div>
