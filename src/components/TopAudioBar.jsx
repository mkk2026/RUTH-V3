...
const TopAudioBar = ({ getAudioData }) => {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            const currentAudioData = getAudioData ? getAudioData() : new Array(32).fill(0);

            for (let i = 0; i < totalBars / 2; i++) {
                const value = currentAudioData[i % currentAudioData.length] || 0;
