    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            if (audioDataRef && audioDataRef.current) {
                ...
                // Performance: Avoid Array.prototype.reduce inside requestAnimationFrame
                // to eliminate per-element callback allocation overhead and garbage collection jank.
                let sum = 0;
