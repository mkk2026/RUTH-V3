    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            if (audioDataRef && audioDataRef.current) {
                ...
                // Bolt Optimization: Replace Array.prototype.reduce with a standard for loop
                // to eliminate per-element callback allocation overhead in this hot animation loop.
                // This reduces garbage collection pressure and prevents frame drops/jank.
                let sum = 0;
