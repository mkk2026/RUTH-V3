...
const Visualizer = ({ audioDataRef, isListening, width = 600, height = 400 }) => {
    ...
    // Use a ref for isListening to avoid re-creating the animation loop on every change
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            // Calculate current intensity from audioDataRef
            const audioData = audioDataRef?.current || [];
            const intensity = audioData.length > 0
