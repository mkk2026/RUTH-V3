...
const Visualizer = ({ audioDataRef, isListening, width = 600, height = 400 }) => {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            // ⚡ BOLT OPTIMIZATION: Calculate intensity within animation frame, reading from ref
            // avoiding prop/state re-renders entirely.
            const data = audioDataRef?.current || [];
            const currentIntensity = data.length > 0
